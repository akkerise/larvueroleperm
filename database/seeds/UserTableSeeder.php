...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $superAdmin = new User();
        $superAdmin->name = 'I am admin';
        $superAdmin->email = 'admin@test.com';
        $superAdmin->password = bcrypt('secret');
        $superAdmin->save();
        $superAdmin->roles()->attach($admin_role);
        $superAdmin->permissions()->attach($dev_create_perm);
        $superAdmin->permissions()->attach($dev_delete_perm);
        $superAdmin->permissions()->attach($manager_perm);
    }
}
